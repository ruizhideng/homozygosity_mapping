...
if [ -z $fam ];then
    # plink --bfile ex --homozyg group --homozyg-gap 100000 --homozyg-kb 100 --homozyg-window-het 0 --homozyg-window-snp 5 --out out  --allow-extra-chr #UGP2 centogene 
    plink --bfile ex --homozyg group --homozyg-gap 10000 --homozyg-kb 1000 --homozyg-window-het 1 --homozyg-window-missing 10 --homozyg-window-snp 20 --homozyg-density 10000 --homozyg-snp 10 --homozyg-window-threshold 0.05 --out out  --allow-extra-chr #Kancheva 
else
    # plink --bfile ex --fam $fam --homozyg group --homozyg-gap 100000 --homozyg-kb 100 --homozyg-window-het 0 --homozyg-window-snp 5 --out out  --allow-extra-chr #UGP2 centogene 
    plink --bfile ex --fam $fam --homozyg group --homozyg-gap 10000 --homozyg-kb 1000 --homozyg-window-het 1 --homozyg-window-missing 10 --homozyg-window-snp 20 --homozyg-density 10000 --homozyg-snp 10 --homozyg-window-threshold 0.05 --out out  --allow-extra-chr #Kancheva 
fi
